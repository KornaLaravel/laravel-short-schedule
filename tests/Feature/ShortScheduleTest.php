...
it('will execute a command registered via the facade', function () {
...
it('wont run whilst in maintenance mode', function () {
...
it('does not run if already running on another server', function () {
